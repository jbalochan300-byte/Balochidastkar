    ...
    <main>
      <section className="shop-intro">
        <div className="container py-5">
          ...
          <p className="text-secondary mb-0">Balochidastkar brings together heritage, practical elegance, and the confidence of a piece made to be worn and remembered.</p>
        </div>
      </section>
