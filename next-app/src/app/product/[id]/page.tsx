        ...
        <div className="row g-5 align-items-start">
          <div className="col-lg-7">
            <div className="product-gallery-main mb-3">
              {primaryImage ? <img src={primaryImage} alt={product.name} /> : <div className="product-image-placeholder">Balochidastkar</div>}
            </div>
          ...
          <div className="col-lg-5">
            <p className="eyebrow mb-2">Balochidastkar</p>
