  ...
  return (
    <main>
            ...
            <div key={product.id} className="col-md-6 col-lg-4">
              <article className="product-card h-100">
                <Link className="product-image" href={`/product/${product.id}`}>
                  {product.imagePath ? <img src={product.imagePath} alt={product.name} /> : <span className="product-image-placeholder">Balochidastkar</span>}
                </Link>
      ...
      <section className="container py-5 home-section">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
          <div>
            <p className="eyebrow mb-2">The Balochidastkar standard</p>
      ...
      <Link className="sticky-cta" href="/shop">Explore Balochi Handcraft <span aria-hidden="true">&rarr;</span></Link>
    </main>
  );
}
